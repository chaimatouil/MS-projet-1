					...
					<div class="col-lg-8 col-md-12 col-12">
						...
						<div class="right-content">
							<ul class="list-main">
								...
								<li><i class="ti-power-off"></i><a href="connexion.php">Se connecter</a></li>							</ul>
						</div>
						<!-- End Top Right -->
					</div>
				</div>
				...
				<div class="row">
					<div class="col-lg-2 col-md-2 col-12">
						...
						<div class="search-top">
							...
							<!-- Search Form -->
							<div class="search-top">
								<form class="search-form" action="produits.php" method="POST">
					...
					<div class="col-12">
						<div class="bread-inner">
							<ul class="bread-list">
								...
								<li class="active"><a href="connexion.html">Produits</a></li>
							</ul>
						</div>
					</div>
				</div>
